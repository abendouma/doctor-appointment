...
public class NotifyHelperService
{
	static private Logger logger = Logger.getLogger (NotifyHelperService.class);
	...
	) throws Exception
	{
		...
		if (callingTimeOK == false){
			...
			appointmentCancelNoCall(appointmentInfo, messages);
			return;
		}
		if (
			(patientRecord.email.equals ("") == false) &&
